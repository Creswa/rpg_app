...
class MidFrame(ttk.Frame):
    ...
    def create_layout_and_widgets(self):
        # layout
        global SkillsFrame
        SkillsFrame = tk.Frame(self)

        # create widgets
        SkillsFrame.pack(expand=True, fill="both")
...
class BottomFrame(ttk.Frame):
    ...
    def create_new_skill(self):
        if SkillsFrame is not None:
            NewSkill(SkillsFrame)
    ...
    def create_layout_and_widgets(self):
        ...
        # create widgets
        skill_name = ttk.Entry(self)
        add_skill_button = ttk.Button(self, text = 'Add skills')
...
class NewSkill(ttk.Frame):
        ...
        def create(self):
            ...
            #new_skill_name_input = parent.new_skill_name.get() # string variable for the new skill

            # creating widgets
            skill_name = ttk.Label(new_skill_frame, anchor="w", borderwidth=1, relief="solid")
